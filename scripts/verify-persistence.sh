...
(
  cd apps/api
  DATASNOOP_TEST_DATABASE_URL="postgres://datasnoop:datasnoop@127.0.0.1:54329/datasnoop_test?sslmode=disable" go test ./internal/persistence -run '^TestStorePersistOutcomes$'
)
