...
ADRs preserve structural decisions and their rationale. Specs remain the normative source for system behavior.

| ADR | Decision | State |
|---|---|---|
| [0001](0001-otlp-as-ingestion-contract.md) | OTLP as the external contract | Accepted |
| [0002](0002-go-sdk-as-reference-sdk.md) | Go SDK as the reference implementation | Accepted |
| [0003](0003-single-service-first.md) | Single-service investigation first | Accepted |
